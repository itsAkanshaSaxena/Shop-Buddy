                            ...
                            <div class="ht__product__dtl">
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left mb-6">
                                        <p><span class="text-gray-700 text-sm">Categories:</span>
                                        <!--<ul class="pro__cat__list">-->
                                            <span class="text-gray-400 text-sm"><a href="#"><?php echo $get_product['0']['categories']?></a></span>
                                        </p>
                                    </div>
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <a class="fr__btn" href="login.php">
